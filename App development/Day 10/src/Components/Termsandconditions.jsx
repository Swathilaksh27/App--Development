...
export default function Termsandconditions() {
  ...
  <p>
    ...
    Do not continue to use classy lens if you do
  ...
  <p>
    We employ the use of cookies. By accessing designer eyewear and sunglasses
    boutique, you agreed to use cookies in agreement with the Classy Lens's
    Privacy Policy.{" "}
  </p>
  <p>
  ...
  <p>
    Unless otherwise stated, Classy Lens and/or its licensors own the
    intellectual property rights for all material on designer eyewear and
    sunglasses boutique. All intellectual property rights are reserved. You may
    access this from designer eyewear and sunglasses boutique for your own
    personal use subjected to restrictions set in these terms and conditions.
  </p>
  <p>You must not:</p>
  <ul>
    <li>Republish material from designer eyewear and sunglasses boutique</li>
    <li>
      Sell, rent or sub-license material from designer eyewear and sunglasses
      boutique
    </li>
    <li>
      Reproduce, duplicate or copy material from designer eyewear and sunglasses
      boutique
    </li>
    <li>Redistribute content from designer eyewear and sunglasses boutique</li>
  </ul>
  
  <p>
    Parts of this website offer an opportunity for users to post and exchange
    opinions and information in certain areas of the website. Classy Lens does
    not filter, edit, publish or review Comments prior to their presence on the
    website. Comments do not reflect the views and opinions of Classy Lens,its
    ...
    applicable laws, Classy Lens shall not be liable for the Comments or for any
  ...
  <p>
    Classy Lens reserves the right to monitor all Comments and to remove any
  ...
  <p>
    You hereby grant Classy Lens a non-exclusive license to use, reproduce, edit
  ...
  <p>
    ...
    compensates the absence of Classy Lens; and (d) the link is in the context
  ...
  <p>
    ...
    e-mail to Classy Lens. Please include your name, your organization name,
  ...
  <p>
    No use of Classy Lens's logo or other artwork will be allowed for linking
