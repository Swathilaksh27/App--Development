  ...
  return (
    ...
    <div className="sidebar">
      ...
      <ul className="sidebar-menu">
        ...
        <li><button className='button'><PaymentIcon/>  VIEW CUSTOMER PAYMENT</button></li>
        <Link to="/" style={{textDecoration:'none',color:'inherit'}}><li><button className='button'><LogoutIcon/>LOGOUT</button></li></Link>
      </ul>
      </div>
      </div>
      );
